...
CONTAINER_NAME="hostinfo-springboot-container"
DISPLAY_NAME="hostinfo-springboot-instance"
APP_PORT="8080"
...
get_ci_details() {
    ...
    if [ -n "$CONTAINER_PRIVATE_IP" ] && [ "$CONTAINER_PRIVATE_IP" != "null" ]; then
        ...
        if [ -n "$CONTAINER_PUBLIC_IP" ] && [ "$CONTAINER_PUBLIC_IP" != "null" ]; then
            ...
            echo -e "${GREEN}Public URL:${NC}  http://${CONTAINER_PUBLIC_IP}:${APP_PORT}/springboot"
        fi
        
        echo -e "${GREEN}Private URL:${NC} http://${CONTAINER_PRIVATE_IP}:${APP_PORT}/springboot"
        echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    else
